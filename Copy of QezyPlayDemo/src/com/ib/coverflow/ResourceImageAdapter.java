...
public class ResourceImageAdapter extends AbstractCoverFlowImageAdapter {
    ...
    private static final int[] DEFAULT_RESOURCE_LIST = { R.drawable.movie, R.drawable.ideabytes, R.drawable.mcdonald,
            R.drawable.honda,R.drawable.cococola };
